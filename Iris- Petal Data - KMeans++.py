...
# Perform KMeans++ clustering (3 clusters for the 3 Iris species) on petal data
kmeans = KMeans(n_clusters=3, init='k-means++', random_state=42)
kmeans_labels = kmeans.fit_predict(X_petal)  # Get cluster labels for petal data
...
df['Cluster'] = kmeans_labels  # KMeans++ cluster labels based on petal data
