...
# Perform Spectral Clustering (3 clusters for the 3 Iris species) on sepal data
spectral = SpectralClustering(n_clusters=3,  affinity='rbf', gamma=0.7, random_state=42)
spectral_labels = spectral.fit_predict(X_sepal)  # Get cluster labels for sepal data
...
df['Cluster'] = spectral_labels  # Spectral clustering labels based on sepal data
